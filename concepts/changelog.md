...
|:---|:---|:---|
|Addition|beta|Added new complex types:<br/>[androidEnrollmentCompanyCode](../api-reference/beta/resources/intune-androidforwork-androidenrollmentcompanycode.md)<br/>[deviceAndAppManagementAssignedRoleDetails](../api-reference/beta/resources/intune-rbac-deviceandappmanagementassignedroledetails.md)<br/>[edgeHomeButtonConfiguration](../api-reference/beta/resources/intune-deviceconfig-edgehomebuttonconfiguration.md)<br/>[edgeHomeButtonHidden](../api-reference/beta/resources/intune-deviceconfig-edgehomebuttonhidden.md)<br/>[edgeHomeButtonLoadsStartPage](../api-reference/beta/resources/intune-deviceconfig-edgehomebuttonloadsstartpage.md)<br/>[edgeHomeButtonOpensCustomURL](../api-reference/beta/resources/intune-deviceconfig-edgehomebuttonopenscustomurl.md)<br/>[edgeHomeButtonOpensNewTab](../api-reference/beta/resources/intune-deviceconfig-edgehomebuttonopensnewtab.md)<br/>[groupPolicyPresentationDropdownListItem](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationdropdownlistitem.md)<br/>[macOsVppAppRevokeLicensesActionResult](../api-reference/beta/resources/intune-apps-macosvppapprevokelicensesactionresult.md)<br/>|
|Addition|beta|Added new entities:<br/>[groupPolicyConfiguration](../api-reference/beta/resources/intune-grouppolicy-grouppolicyconfiguration.md)<br/>[groupPolicyConfigurationAssignment](../api-reference/beta/resources/intune-grouppolicy-grouppolicyconfigurationassignment.md)<br/>[groupPolicyDefinition](../api-reference/beta/resources/intune-grouppolicy-grouppolicydefinition.md)<br/>[groupPolicyDefinitionFile](../api-reference/beta/resources/intune-grouppolicy-grouppolicydefinitionfile.md)<br/>[groupPolicyDefinitionValue](../api-reference/beta/resources/intune-grouppolicy-grouppolicydefinitionvalue.md)<br/>[groupPolicyPresentation](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentation.md)<br/>[groupPolicyPresentationCheckBox](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationcheckbox.md)<br/>[groupPolicyPresentationComboBox](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationcombobox.md)<br/>[groupPolicyPresentationDecimalTextBox](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationdecimaltextbox.md)<br/>[groupPolicyPresentationDropdownList](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationdropdownlist.md)<br/>[groupPolicyPresentationListBox](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationlistbox.md)<br/>[groupPolicyPresentationLongDecimalTextBox](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationlongdecimaltextbox.md)<br/>[groupPolicyPresentationMultiTextBox](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationmultitextbox.md)<br/>[groupPolicyPresentationText](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationtext.md)<br/>[groupPolicyPresentationTextBox](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationtextbox.md)<br/>[groupPolicyPresentationValue](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationvalue.md)<br/>[groupPolicyPresentationValueBoolean](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationvalueboolean.md)<br/>[groupPolicyPresentationValueDecimal](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationvaluedecimal.md)<br/>[groupPolicyPresentationValueList](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationvaluelist.md)<br/>[groupPolicyPresentationValueLongDecimal](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationvaluelongdecimal.md)<br/>[groupPolicyPresentationValueMultiText](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationvaluemultitext.md)<br/>[groupPolicyPresentationValueText](../api-reference/beta/resources/intune-grouppolicy-grouppolicypresentationvaluetext.md)<br/>[intuneBrandingProfileAssignment](../api-reference/beta/resources/intune-wip-intunebrandingprofileassignment.md)<br/>[macOsVppApp](../api-reference/beta/resources/intune-apps-macosvppapp.md)<br/>[macOsVppAppAssignedLicense](../api-reference/beta/resources/intune-apps-macosvppappassignedlicense.md)<br/>[windowsDeliveryOptimizationConfiguration](../api-reference/beta/resources/intune-deviceconfig-windowsdeliveryoptimizationconfiguration.md)<br/>|
|Addition|beta|Added new enum types:<br/>[browserSyncSetting](../api-reference/beta/resources/intune-deviceconfig-browsersyncsetting.md)<br/>[edgeOpenOptions](../api-reference/beta/resources/intune-deviceconfig-edgeopenoptions.md)<br/>[edgeTelemetryMode](../api-reference/beta/resources/intune-deviceconfig-edgetelemetrymode.md)<br/>[groupPolicyConfigurationType](../api-reference/beta/resources/intune-grouppolicy-grouppolicyconfigurationtype.md)<br/>[groupPolicyDefinitionClassType](../api-reference/beta/resources/intune-grouppolicy-grouppolicydefinitionclasstype.md)<br/>[groupPolicyType](../api-reference/beta/resources/intune-grouppolicy-grouppolicytype.md)<br/>[internetExplorerMessageSetting](../api-reference/beta/resources/intune-deviceconfig-internetexplorermessagesetting.md)<br/>[windowsKioskAppType](../api-reference/beta/resources/intune-deviceconfig-windowskioskapptype.md)<br/>|
|Addition|beta|Added the **appRemovalBlocked**, **usbRestrictedModeBlocked**, **passwordBlockAutoFill**, **passwordBlockProximityRequests**, **passwordBlockAirDropSharing** and **dateAndTimeForceSetAutomatically** properties to the [iosGeneralDeviceConfiguration](../api-reference/beta/resources/intune-deviceconfig-iosgeneraldeviceconfiguration.md) entity|
|Addition|beta|Added the **appType** property to the [windowsKioskAppBase](../api-reference/beta/resources/intune-deviceconfig-windowskioskappbase.md) complex type|
|Addition|beta|Added the **assignments** navigation property to the [intuneBrandingProfile](../api-reference/beta/resources/intune-wip-intunebrandingprofile.md) entity|
|Addition|beta|Added the **companyCodes** and **androidDeviceOwnerFullyManagedEnrollmentEnabled** properties to the [androidManagedStoreAccountEnterpriseSettings](../api-reference/beta/resources/intune-androidforwork-androidmanagedstoreaccountenterprisesettings.md) entity|
|Addition|beta|Added the **deviceComplianceReportSummarizationDateTime** properties to the [deviceManagement](../api-reference/beta/resources/intune-androidforwork-devicemanagement.md) entity|
|Addition|beta|Added the **experienceDoNotSyncBrowserSettings**, **edgeTelemetryForMicrosoft365Analytics**, **edgeNewTabPageURL**, **edgeHomeButtonConfiguration**, **edgeHomeButtonConfigurationEnabled**, **edgeOpensWith**, **edgeBlockSideloadingExtensions**, **edgeRequiredExtensionPackageFamilyNames**, **edgeBlockPrinting**, **edgeFavoritesBarVisibility**, **edgeBlockSavingHistory**, **edgeBlockFullScreenMode**, **edgeBlockWebContentOnNewTabPage**, **edgeBlockTabPreloading**, **edgeBlockPrelaunch**, **edgeShowMessageWhenOpeningInternetExplorerSites**, **edgePreventCertificateErrorOverride** and **edgeSendIntranetTrafficToInternetExplorer** properties to the [windows10GeneralConfiguration](../api-reference/beta/resources/intune-deviceconfig-windows10generalconfiguration.md) entity|
|Addition|beta|Added the **groupPolicyConfigurations**, **groupPolicyDefinitions** and **groupPolicyDefinitionFiles** navigation properties to the [deviceManagement](../api-reference/beta/resources/intune-androidforwork-devicemanagement.md) entity|
|Addition|beta|Added the **isAssigned** property to the [mobileApp](../api-reference/beta/resources/intune-apps-mobileapp.md) entity|
|Addition|beta|Added the **kioskModeWallpaperUrl**, **kioskModeExitCode** and **kioskModeVirtualHomeButtonEnabled** properties to the [androidDeviceOwnerGeneralDeviceConfiguration](../api-reference/beta/resources/intune-deviceconfig-androiddeviceownergeneraldeviceconfiguration.md) entity|
|Addition|beta|Added the **osMinimumBuildVersion** and **osMaximumBuildVersion** properties to the [iosCompliancePolicy](../api-reference/beta/resources/intune-deviceconfig-ioscompliancepolicy.md) entity|
|Addition|beta|Added the **osMinimumBuildVersion** and **osMaximumBuildVersion** properties to the [macOSCompliancePolicy](../api-reference/beta/resources/intune-deviceconfig-macoscompliancepolicy.md) entity|
|Addition|beta|Added the **passwordBlockAutoFill**, **passwordBlockProximityRequests** and **passwordBlockAirDropSharing** properties to the [macOSGeneralDeviceConfiguration](../api-reference/beta/resources/intune-deviceconfig-macosgeneraldeviceconfiguration.md) entity|
|Addition|beta|Added the **patchVersion** property to the [androidManagedAppRegistration](../api-reference/beta/resources/intune-mam-androidmanagedappregistration.md) entity|
|Addition|beta|Added the **refreshDeviceComplianceReportSummarization** action on [deviceCompliancePolicy](../api-reference/beta/resources/intune-deviceconfig-devicecompliancepolicy.md) collection |
|Addition|beta|Added the **roleScopeTagIds** property to the [iosVppEBook](../api-reference/beta/resources/intune-books-iosvppebook.md) entity|
|Addition|beta|Added the **roleScopeTagIds** property to the [roleDefinition](../api-reference/beta/resources/intune-rbac-roledefinition.md) entity|
|Addition|beta|Added the **roleScopeTagIds** property to the [vppToken](../api-reference/beta/resources/intune-onboarding-vpptoken.md) entity|
|Addition|beta|Added the **smimeEncryptByDefaultEnabled**, **smimeSigningEnabled**, **smimeSigningUserOverrideEnabled**, **smimeEncryptByDefaultUserOverrideEnabled**, **smimeSigningCertificateUserOverrideEnabled** and **smimeEncryptionCertificateUserOverrideEnabled** properties to the [iosEasEmailProfileConfiguration](../api-reference/beta/resources/intune-deviceconfig-ioseasemailprofileconfiguration.md) entity|
|Addition|beta|Added the **windows10Home**, **windows10HomeChina**, **windows10HomeN**, **windows10HomeSingleLanguage**, **windows10Mobile**, **windows10IoTCore** and **windows10IoTCoreCommercial** members to the [windows10EditionType](../api-reference/beta/resources/intune-deviceconfig-windows10editiontype.md) enum type|
|Addition|beta|Added the [assign](../api-reference/beta/api/intune-grouppolicy-grouppolicyconfiguration-assign.md) action on [groupPolicyConfiguration](../api-reference/beta/resources/intune-grouppolicy-grouppolicyconfiguration.md) |
|Addition|beta|Added the [assign](../api-reference/beta/api/intune-wip-intunebrandingprofile-assign.md) action on [intuneBrandingProfile](../api-reference/beta/resources/intune-wip-intunebrandingprofile.md) |
|Addition|beta|Added the [getAssignedRoleDetails](../api-reference/beta/api/intune-rbac-devicemanagement-getassignedroledetails.md) function on [deviceManagement](../api-reference/beta/resources/intune-androidforwork-devicemanagement.md) |
|Addition|beta|Added the [scopedForResource](../api-reference/beta/api/intune-rbac-devicemanagement-scopedforresource.md) function on [deviceManagement](../api-reference/beta/resources/intune-androidforwork-devicemanagement.md) |
|Addition|beta|Added the [setAndroidDeviceOwnerFullyManagedEnrollmentState](../api-reference/beta/api/intune-androidforwork-androidmanagedstoreaccountenterprisesettings-setandroiddeviceownerfullymanagedenrollmentstate.md) action on [androidManagedStoreAccountEnterpriseSettings](../api-reference/beta/resources/intune-androidforwork-androidmanagedstoreaccountenterprisesettings.md) |
|Change|beta|Changed the following properties on the [windowsIdentityProtectionConfiguration](../api-reference/beta/resources/intune-deviceconfig-windowsidentityprotectionconfiguration.md) entity:<br/>**windowsHelloForBusinessBlocked** from required to optional<br/>|
|Deletion|beta|Removed the **authenticationAllowFIDODevice** property from the [windows10GeneralConfiguration](../api-reference/beta/resources/intune-deviceconfig-windows10generalconfiguration.md) entity|
|Deletion|beta|Removed the **qualityUpdatesPauseStartDateTime** and **featureUpdatesPauseStartDateTime** properties from the [windowsUpdateForBusinessConfiguration](../api-reference/beta/resources/intune-deviceconfig-windowsupdateforbusinessconfiguration.md) entity|
|Deletion|beta|Removed the [getAssignedRoleIdsForLoggedInUser](../api-reference/beta/api/intune-rbac-devicemanagement-getassignedroleidsforloggedinuser.md) function on [deviceManagement](../api-reference/beta/resources/intune-androidforwork-devicemanagement.md) |
|Deletion|beta|Removed the following complex types:<br/>**deviceAndAppManagementAssignedRoleIds**<br/>|
...
| Addition        | Beta        | Added the [unfollow](/graph/api/driveitem-unfollow?view=graph-rest-beta) API |
...
| Change type | Version | Description                              |
|:------------|:--------|:-----------------------------------------|
| Change      | v1.0    | Add optional query filtering capability to [users](/graph/api/user-delta?view=graph-rest-1.0) and [groups](/graph/api/group-delta?view=graph-rest-1.0). |
